...
$(function(){$("#my-menu").mmenu({extensions:["pagedim-black"],offCanvas:{position:"right"},pageScroll:{scroll:!0}}),$("#my-menu").data("mmenu").bind("opened",function(){$(".hamburger").addClass("is-active")}).bind("closed",function(){$(".hamburger").removeClass("is-active")})});